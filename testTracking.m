...
% Shamelessly stolen from matlab example
% type 'edit multiplObjectTracking' into the console for the original
% https://au.mathworks.com/help/vision/examples/motion-based-multiple-object-tracking.html
...
% foreground objects, and displaying results.
    ...
    function obj = setupSystemObjects()
        ...
        obj.video = videoinput('kinect');
        obj.video.FramesPerTrigger = 1;
        obj.video.TriggerRepeat = Inf;
...
%         start(obj.video);
        trigger(obj.video);
        frame = getdata(obj.video);
        frame = imcrop(frame, [340, 660, 400, 600]);
%         stop(obj.video);
    end
